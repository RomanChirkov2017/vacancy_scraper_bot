...
async def collect_hh_data(keywords):
    ...
    while True:
        ...
        params = {"per_page": 10, "page": page_number, "text": keywords}
    ...
    #data = response.json()
        ...
        print(f"Total vacancies collected: {len(vacancies_hh_json)}")
...
async def collect_sj_data(keywords):
    ...
    while True:
        ...
        params = {"count": 10, "page": page_number, "keyword": keywords}
        #secret_key = API_KEY
    ...
    #data = response.json()
        ...
        print(f"Total vacancies collected: {len(vacancies_sj_json)}")
